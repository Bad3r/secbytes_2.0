...
![crt_injector](crt_injector.png)

Let's compile and run the program `nim c --run crtinjection.nim`
and make sure everything works. By default when you compile Nim code it generates C code.
In the latter section "Integrating into Existing Tooling" verification shall ensue.
...
If you just specifically want the D/Invoke part you can also use the [repository](https://github.com/TheWover/DInvoke)
...
![nimscript_embeddedmessage](nimscript_embeddedmessage.png)
...
Overall, Nim is an interesting language that can jumpstart development instead
...
All code snippets can be found [here](https://github.com/NotoriousRebel/NimbleMusings).
